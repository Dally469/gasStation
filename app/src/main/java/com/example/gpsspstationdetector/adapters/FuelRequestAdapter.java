...
public class FuelRequestAdapter extends FirebaseRecyclerAdapter<FuelRequest, FuelRequestAdapter.MyViewHolder>
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView name, phone, fuel, type,status;
        ...
        public MyViewHolder(View view) {
            ...
            fuel = view.findViewById(R.id.client_fuel_liter);
            type = view.findViewById(R.id.client_fuel_type);
    ...
    public FuelRequestAdapter(Context context, FirebaseRecyclerOptions<FuelRequest> options) {
        super(options);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_fuel_request_layout, parent, false);
    ...
    @Override
    protected void onBindViewHolder(@NonNull MyViewHolder holder, int position, @NonNull FuelRequest model) {

        holder.name.setText(model.getClient_name());
        holder.phone.setText(model.getClient_phone());
        holder.fuel.setText(model.getFuel_liter());
        holder.type.setText(model.getFuel_type());

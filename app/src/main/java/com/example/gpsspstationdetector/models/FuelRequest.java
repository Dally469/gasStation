...
public class FuelRequest {
    ...
    public FuelRequest(String station_id, String client_name, String client_phone, String client_plate_nbr, String fuel_type, String fuel_liter, double client_latitude, double client_longitude, String date, String status) {
    ...
    public void setFuel_liter(String fuel_liter) {
        this.fuel_liter = fuel_liter;
    }
